...
**L’esito di questo progetto può essere sintetizzato nella creazione di
un kit per i Comuni italiani, comprensivo di architettura
dell’informazione e template html.**

`Vai al kit <https://designers.italia.it/kit/comuni/>`__

**Tutti i comuni, o più in generale la comunità open source e le
...
**Il progetto nasce dall’analisi dell’esperienza di molti Comuni
italiani e in particolare dalla collaborazione con i Comuni di Firenze,
dove il progetto ha mosso i primi passi, e di Cagliari, che sarà il
primo comune italiano ad adottare questo modello. Inoltre si basa su un
utile scambio di esperienze con il progetto Myportal 3 e i servizi ai
comuni realizzati dalla Regione Veneto e sulla community e piattaforma
Comunweb che aggrega tutti i comuni del Trentino.**
...
software open
source <https://docs.italia.it/AgID/linee-guida-riuso-software/lg-acquisizione-e-riuso-software-per-pa-docs/it/bozza/index.html>`__\ **della
Pubblica Amministrazione.**
