...
.. list-table::
   ...
   * - **Successo**
     - In tutte le schede servizio tutte le voci obbligatorie e i relativi contenuti sono presenti nel seguente ordine: 
       ...
       **e** devono essere presenti almeno 10 schede servizio accessibili dalla pagina "servizi" **e** il sito presenta i *data attribute* indicati nella `Documentazione delle App di valutazione dell’adesione ai modelli <https://docs.italia.it/italia/designers-italia/app-valutazione-modelli-docs/>`_ per questo criterio
   ...
   * - **Tolleranza**
     - Anche solo in una scheda servizio fino a 2 delle seguenti voci obbligatorie e i relativi contenuti non sono presenti:
       ...
       **e** devono essere presenti almeno 10 schede servizio accessibili dalla pagina "Servizi" **e** il sito presenta i data attribute indicati nella `Documentazione delle App di valutazione dell’adesione ai modelli <https://docs.italia.it/italia/designers-italia/app-valutazione-modelli-docs/>`_.
   ...
   * - **Fallimento**
     - Anche solo in una scheda servizio più di 2 delle seguenti voci obbligatorie e i relativi contenuti non sono presenti:
       ...
       **o** non sono presenti almeno 10 schede servizio accessibili dalla pagina "Servizi" **o** il sito presenta i data attribute indicati nella `Documentazione delle App di valutazione dell’adesione ai modelli <https://docs.italia.it/italia/designers-italia/app-valutazione-modelli-docs/>`_.
